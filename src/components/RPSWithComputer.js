...
import rpsHOC, { options, playElements } from './RPSHOC'
import { Container, Row, Col } from 'react-bootstrap';
import Select from "react-select";

import userH from '../assets/smiley-happy.jpeg'
import userN from '../assets/smiley-normal.jpeg'
import userL from '../assets/smiley-angry.jpeg'
import userW from '../assets/smiley-winner.jpeg'

import compL from '../assets/Comp-angry.png'
import compW from '../assets/Comp-winner.png'
import compN from '../assets/Comp-normal.jpeg'
...
const RPSWithComputer = (props) => {
    ...
    return (
        <Container >
            ...
            {winner &&  <Confetti confettiSource={winner === 'p1' ? { x: 0, y: 50, w: 50, h: 50 } : {x: window.innerWidth, y: 50, w: 50, h: 50}}></Confetti>}
            {winner &&
